package so.trophy.src.main.java;
...
import so.trophy.core.LogConfig;
...
public class TrophyApiClientBuilder {
   ...
   * Sets sdkVersion
   */
  public TrophyApiClientBuilder sdkVersion(String sdkVersion) {
   ...
   * Sets tenantId
   */
  public TrophyApiClientBuilder tenantId(String tenantId) {
   ...
   */
  public TrophyApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public TrophyApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public TrophyApiClientBuilder logging(LogConfig logging) {
   ...
   */
  public TrophyApiClientBuilder addHeader(String name, String value) {
  ...
  public TrophyApiClient build() {
    ...
    if (sdkVersion == null) {
      throw new RuntimeException("Please provide sdkVersion");
    }
    validateConfiguration();
    return new TrophyApiClient(buildClientOptions());
  }
}
