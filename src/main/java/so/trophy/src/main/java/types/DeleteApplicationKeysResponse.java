...
@JsonDeserialize(
    builder = DeleteApplicationKeysResponse.Builder.class
)
public final class DeleteApplicationKeysResponse {
  ...
  private DeleteApplicationKeysResponse(List<DeletedResource> deleted, List<AdminIssue> issues,
  ...
  /**
   * @return Array of deleted application API key IDs.
   */
  ...
  /**
   * @return Array of issues encountered during deletion.
   */
  @JsonProperty("issues")
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DeleteApplicationKeysResponse && equalTo((DeleteApplicationKeysResponse) other);
  }
  ...
  private boolean equalTo(DeleteApplicationKeysResponse other) {
  ...
  public static final class Builder {
    ...
    public Builder from(DeleteApplicationKeysResponse other) {
    ...
    /**
     * <p>Array of deleted application API key IDs.</p>
     */
    @JsonSetter(
        value = "deleted",
        nulls = Nulls.SKIP
    ...
    /**
     * <p>Array of issues encountered during deletion.</p>
     */
    @JsonSetter(
        value = "issues",
        nulls = Nulls.SKIP
    ...
    public DeleteApplicationKeysResponse build() {
      return new DeleteApplicationKeysResponse(deleted, issues, additionalProperties);
    }
