...
public class UsersClient {
   ...
   * Identify a user.
   */
  public User identify(String id, RequestOptions requestOptions) {
    return this.rawClient.identify(id, requestOptions).body();
  }
  ...
  public List<UserAchievementWithStatsResponse> achievements(String id,
      RequestOptions requestOptions) {
    return this.rawClient.achievements(id, requestOptions).body();
  }
   ...
   * Get a user's streak data.
   */
  public StreakResponse streak(String id, RequestOptions requestOptions) {
    return this.rawClient.streak(id, requestOptions).body();
  }
   ...
   * Get a user's points for a specific points system.
   */
  public GetUserPointsResponse points(String id, String key, RequestOptions requestOptions) {
    return this.rawClient.points(id, key, requestOptions).body();
  }
  ...
  public UserLeaderboardResponseWithHistory leaderboard(String id, String key,
      RequestOptions requestOptions) {
    return this.rawClient.leaderboard(id, key, requestOptions).body();
  }
   ...
   * Get a user's year-in-review wrapped data.
   */
  public WrappedResponse wrapped(String id, RequestOptions requestOptions) {
    return this.rawClient.wrapped(id, requestOptions).body();
  }
