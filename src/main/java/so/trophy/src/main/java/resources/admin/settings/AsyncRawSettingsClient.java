...
public class AsyncRawSettingsClient {
   ...
   */
  public CompletableFuture<TrophyApiHttpResponse<AdminSettings>> get() {
    return get(null);
  }
  ...
  public CompletableFuture<TrophyApiHttpResponse<AdminSettings>> get(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getAdminURL()).newBuilder()
      ...
      CompletableFuture<TrophyApiHttpResponse<AdminSettings>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AdminSettings.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<TrophyApiHttpResponse<AdminSettings>> update() {
     ...
     */
    public CompletableFuture<TrophyApiHttpResponse<AdminSettings>> update(
        UpdateAdminSettingsRequest request, RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getAdminURL()).newBuilder()
