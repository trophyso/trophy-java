...
public final class AchievementResponse implements IAchievementResponse {
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.name, this.trigger, this.description, this.badgeUrl, this.key, this.streakLength, this.achievementIds, this.metricId, this.metricValue, this.metricName, this.userAttributes, this.eventAttribute, this.eventAttributes);
  }
  ...
  public static final class Builder implements IdStage, NameStage, TriggerStage, _FinalStage {
    ...
    public AchievementResponse build() {
      return new AchievementResponse(id, name, trigger, description, badgeUrl, key, streakLength, achievementIds, metricId, metricValue, metricName, userAttributes, eventAttribute, eventAttributes, additionalProperties);
    }
