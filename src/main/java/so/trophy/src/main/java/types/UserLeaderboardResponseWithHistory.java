...
@JsonDeserialize(
    builder = UserLeaderboardResponseWithHistory.Builder.class
)
public final class UserLeaderboardResponseWithHistory implements IUserLeaderboardResponse, ILeaderboardResponse {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof UserLeaderboardResponseWithHistory && equalTo((UserLeaderboardResponseWithHistory) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(UserLeaderboardResponseWithHistory other);
  }
  ...
  public interface _FinalStage {
    UserLeaderboardResponseWithHistory build();
  ...
  public static final class Builder implements IdStage, NameStage, KeyStage, RankByStage, StartStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(UserLeaderboardResponseWithHistory other) {
      rank(other.getRank());
