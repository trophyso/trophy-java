...
@JsonDeserialize(
    builder = DeleteAchievementsResponse.Builder.class
)
public final class DeleteAchievementsResponse {
  ...
  private DeleteAchievementsResponse(List<DeletedResource> deleted, List<AdminIssue> issues,
  ...
  /**
   * @return Array of deleted achievements represented by ID.
   */
  ...
  /**
   * @return Array of issues encountered during achievement deletion.
   */
  @JsonProperty("issues")
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DeleteAchievementsResponse && equalTo((DeleteAchievementsResponse) other);
  }
  ...
  private boolean equalTo(DeleteAchievementsResponse other) {
  ...
  public static final class Builder {
    ...
    public Builder from(DeleteAchievementsResponse other) {
    ...
    /**
     * <p>Array of deleted achievements represented by ID.</p>
     */
    @JsonSetter(
        value = "deleted",
        nulls = Nulls.SKIP
    ...
    /**
     * <p>Array of issues encountered during achievement deletion.</p>
     */
    @JsonSetter(
        value = "issues",
        nulls = Nulls.SKIP
    ...
    public DeleteAchievementsResponse build() {
      return new DeleteAchievementsResponse(deleted, issues, additionalProperties);
    }
