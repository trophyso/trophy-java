package so.trophy.src.main.java.resources.users;
...
public class AsyncRawUsersClient {
  ...
  public CompletableFuture<TrophyApiHttpResponse<User>> create(UpsertedUser request,
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, User.class), response));
              return;
            }
            try {
    ...
    public CompletableFuture<TrophyApiHttpResponse<User>> get(String id,
      ...
      public CompletableFuture<TrophyApiHttpResponse<User>> identify(String id,
          RequestOptions requestOptions) {
        return identify(id,UpdatedUser.builder().build(),requestOptions);
      }
      ...
      public CompletableFuture<TrophyApiHttpResponse<User>> identify(String id, UpdatedUser request,
        ...
        public CompletableFuture<TrophyApiHttpResponse<User>> update(String id,
            RequestOptions requestOptions) {
          return update(id,UpdatedUser.builder().build(),requestOptions);
        }
        ...
        public CompletableFuture<TrophyApiHttpResponse<User>> update(String id, UpdatedUser request,
          ...
          public CompletableFuture<TrophyApiHttpResponse<UserPreferencesResponse>> getPreferences(
            ...
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getApiURL()).newBuilder()
              ...
              .addPathSegments("users")
              .addPathSegment(id)
              .addPathSegments("preferences");if (requestOptions != null) {
                requestOptions.getQueryParameters().forEach((_key, _value) -> {
                  httpUrl.addQueryParameter(_key, _value);
                } );
              }
              ...
              client.newCall(okhttpRequest).enqueue(new Callback() {
                ...
                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                  try (ResponseBody responseBody = response.body()) {
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                      future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UserPreferencesResponse.class), response));
                      return;
                    }
                    try {
                      switch (response.code()) {
            ...
            public CompletableFuture<TrophyApiHttpResponse<UserPreferencesResponse>> updatePreferences(
                String id, RequestOptions requestOptions) {
              return updatePreferences(id,UpdateUserPreferencesRequest.builder().build(),requestOptions);
            }
            ...
            public CompletableFuture<TrophyApiHttpResponse<UserPreferencesResponse>> updatePreferences(
               ...
               */
              public CompletableFuture<TrophyApiHttpResponse<List<MetricResponse>>> allMetrics(
                  String id) {
              ...
              public CompletableFuture<TrophyApiHttpResponse<List<MetricResponse>>> allMetrics(
                  ...
                  client.newCall(okhttpRequest).enqueue(new Callback() {
                    ...
                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                      try (ResponseBody responseBody = response.body()) {
                        String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                        if (response.isSuccessful()) {
                          future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<MetricResponse>>() {}), response));
                          return;
                        }
                        try {
                          switch (response.code()) {
                 ...
                 */
                public CompletableFuture<TrophyApiHttpResponse<MetricResponse>> singleMetric(
                 ...
                 */
                public CompletableFuture<TrophyApiHttpResponse<MetricResponse>> singleMetric(
                    String id, String key, RequestOptions requestOptions) {
                  HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getApiURL()).newBuilder()

                    .addPathSegments("users")
                    .addPathSegment(id)
                    .addPathSegments("metrics")
                    .addPathSegment(key);if (requestOptions != null) {
                      requestOptions.getQueryParameters().forEach((_key, _value) -> {
                        httpUrl.addQueryParameter(_key, _value);
                      } );
                    }
                    ...
                    client.newCall(okhttpRequest).enqueue(new Callback() {
                      ...
                      public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                        try (ResponseBody responseBody = response.body()) {
                          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                          if (response.isSuccessful()) {
                            future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, MetricResponse.class), response));
                            return;
                          }
                          try {
                            switch (response.code()) {
                  ...
                  public CompletableFuture<TrophyApiHttpResponse<List<UsersMetricEventSummaryResponseItem>>> metricEventSummary(
                      ...
                      client.newCall(okhttpRequest).enqueue(new Callback() {
                        ...
                        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                          try (ResponseBody responseBody = response.body()) {
                            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                            if (response.isSuccessful()) {
                              future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<UsersMetricEventSummaryResponseItem>>() {}), response));
                              return;
                            }
                            try {
                              switch (response.code()) {
                    ...
                    public CompletableFuture<TrophyApiHttpResponse<List<UserAchievementWithStatsResponse>>> achievements(
                        String id, RequestOptions requestOptions) {
                      return achievements(id,UsersAchievementsRequest.builder().build(),requestOptions);
                    }
                    ...
                    public CompletableFuture<TrophyApiHttpResponse<List<UserAchievementWithStatsResponse>>> achievements(
                        ...
                        client.newCall(okhttpRequest).enqueue(new Callback() {
                          ...
                          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                            try (ResponseBody responseBody = response.body()) {
                              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                              if (response.isSuccessful()) {
                                future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<UserAchievementWithStatsResponse>>() {}), response));
                                return;
                              }
                              try {
                                switch (response.code()) {
                       ...
                       */
                      public CompletableFuture<TrophyApiHttpResponse<StreakResponse>> streak(
                          String id) {
                      ...
                      public CompletableFuture<TrophyApiHttpResponse<StreakResponse>> streak(
                          String id, RequestOptions requestOptions) {
                        return streak(id,UsersStreakRequest.builder().build(),requestOptions);
                      }
                       ...
                       */
                      public CompletableFuture<TrophyApiHttpResponse<StreakResponse>> streak(
                          String id, UsersStreakRequest request) {
                       ...
                       */
                      public CompletableFuture<TrophyApiHttpResponse<StreakResponse>> streak(
                          String id, UsersStreakRequest request, RequestOptions requestOptions) {
                        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getApiURL()).newBuilder()
                          ...
                          client.newCall(okhttpRequest).enqueue(new Callback() {
                            ...
                            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                              try (ResponseBody responseBody = response.body()) {
                                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                if (response.isSuccessful()) {
                                  future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, StreakResponse.class), response));
                                  return;
                                }
                                try {
                                  switch (response.code()) {
                         ...
                         */
                        public CompletableFuture<TrophyApiHttpResponse<GetUserPointsResponse>> points(
                            String id, String key) {
                        ...
                        public CompletableFuture<TrophyApiHttpResponse<GetUserPointsResponse>> points(
                            String id, String key, RequestOptions requestOptions) {
                          return points(id,key,UsersPointsRequest.builder().build(),requestOptions);
                        }
                         ...
                         */
                        public CompletableFuture<TrophyApiHttpResponse<GetUserPointsResponse>> points(
                            String id, String key, UsersPointsRequest request) {
                        ...
                        public CompletableFuture<TrophyApiHttpResponse<GetUserPointsResponse>> points(
                            ...
                            client.newCall(okhttpRequest).enqueue(new Callback() {
                              ...
                              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                try (ResponseBody responseBody = response.body()) {
                                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                  if (response.isSuccessful()) {
                                    future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetUserPointsResponse.class), response));
                                    return;
                                  }
                                  try {
                                    switch (response.code()) {
                           ...
                           */
                          public CompletableFuture<TrophyApiHttpResponse<List<PointsBoost>>> pointsBoosts(
                              String id, String key) {
                          ...
                          public CompletableFuture<TrophyApiHttpResponse<List<PointsBoost>>> pointsBoosts(
                              ...
                              client.newCall(okhttpRequest).enqueue(new Callback() {
                                ...
                                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                  try (ResponseBody responseBody = response.body()) {
                                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                    if (response.isSuccessful()) {
                                      future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<PointsBoost>>() {}), response));
                                      return;
                                    }
                                    try {
                                      switch (response.code()) {
                            ...
                            public CompletableFuture<TrophyApiHttpResponse<List<UsersPointsEventSummaryResponseItem>>> pointsEventSummary(
                                ...
                                client.newCall(okhttpRequest).enqueue(new Callback() {
                                  ...
                                  public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                    try (ResponseBody responseBody = response.body()) {
                                      String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                      if (response.isSuccessful()) {
                                        future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<UsersPointsEventSummaryResponseItem>>() {}), response));
                                        return;
                                      }
                                      try {
                                        switch (response.code()) {
                              ...
                              public CompletableFuture<TrophyApiHttpResponse<UserLeaderboardResponseWithHistory>> leaderboard(
                                  String id, String key, RequestOptions requestOptions) {
                                return leaderboard(id,key,UsersLeaderboardRequest.builder().build(),requestOptions);
                              }
                              ...
                              public CompletableFuture<TrophyApiHttpResponse<UserLeaderboardResponseWithHistory>> leaderboard(
                                  ...
                                  client.newCall(okhttpRequest).enqueue(new Callback() {
                                    ...
                                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                      try (ResponseBody responseBody = response.body()) {
                                        String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                        if (response.isSuccessful()) {
                                          future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UserLeaderboardResponseWithHistory.class), response));
                                          return;
                                        }
                                        try {
                                          switch (response.code()) {
                                 ...
                                 */
                                public CompletableFuture<TrophyApiHttpResponse<WrappedResponse>> wrapped(
                                    String id) {
                                ...
                                public CompletableFuture<TrophyApiHttpResponse<WrappedResponse>> wrapped(
                                    String id, RequestOptions requestOptions) {
                                  return wrapped(id,UsersWrappedRequest.builder().build(),requestOptions);
                                }
                                 ...
                                 */
                                public CompletableFuture<TrophyApiHttpResponse<WrappedResponse>> wrapped(
                                    String id, UsersWrappedRequest request) {
                                    ...
                                    client.newCall(okhttpRequest).enqueue(new Callback() {
                                      ...
                                      public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                        try (ResponseBody responseBody = response.body()) {
                                          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                          if (response.isSuccessful()) {
                                            future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, WrappedResponse.class), response));
                                            return;
                                          }
                                          try {
                                            switch (response.code()) {
