...
@JsonDeserialize(
    builder = DeleteLeaderboardsResponse.Builder.class
)
public final class DeleteLeaderboardsResponse {
  ...
  private DeleteLeaderboardsResponse(List<DeletedResource> deleted, List<AdminIssue> issues,
  ...
  /**
   * @return Array of deleted leaderboards represented by ID.
   */
  ...
  /**
   * @return Array of issues encountered during leaderboard deletion.
   */
  @JsonProperty("issues")
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DeleteLeaderboardsResponse && equalTo((DeleteLeaderboardsResponse) other);
  }
  ...
  private boolean equalTo(DeleteLeaderboardsResponse other) {
  ...
  public static final class Builder {
    ...
    public Builder from(DeleteLeaderboardsResponse other) {
    ...
    /**
     * <p>Array of deleted leaderboards represented by ID.</p>
     */
    @JsonSetter(
        value = "deleted",
        nulls = Nulls.SKIP
    ...
    /**
     * <p>Array of issues encountered during leaderboard deletion.</p>
     */
    @JsonSetter(
        value = "issues",
        nulls = Nulls.SKIP
    ...
    public DeleteLeaderboardsResponse build() {
      return new DeleteLeaderboardsResponse(deleted, issues, additionalProperties);
    }
