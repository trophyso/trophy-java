package so.trophy.src.main.java.resources.leaderboards;
...
public class RawLeaderboardsClient {
  ...
  public TrophyApiHttpResponse<List<LeaderboardsAllResponseItem>> all(
    ...
    return all(LeaderboardsAllRequest.builder().build(),requestOptions);
  }
  ...
  public TrophyApiHttpResponse<List<LeaderboardsAllResponseItem>> all(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getApiURL()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<LeaderboardsAllResponseItem>>() {}), response);
        }
        try {
    ...
    public TrophyApiHttpResponse<LeaderboardResponseWithRankings> get(String key,
        RequestOptions requestOptions) {
      return get(key,LeaderboardsGetRequest.builder().build(),requestOptions);
    }
    ...
    public TrophyApiHttpResponse<LeaderboardResponseWithRankings> get(String key,
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getApiURL()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, LeaderboardResponseWithRankings.class), response);
          }
          try {
            switch (response.code()) {
              case 401:throw new UnauthorizedError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
