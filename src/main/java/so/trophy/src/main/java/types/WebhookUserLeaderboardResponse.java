...
@JsonDeserialize(
    builder = WebhookUserLeaderboardResponse.Builder.class
)
public final class WebhookUserLeaderboardResponse implements IUserLeaderboardResponse, ILeaderboardResponse {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof WebhookUserLeaderboardResponse && equalTo((WebhookUserLeaderboardResponse) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(WebhookUserLeaderboardResponse other);
  }
  ...
  public interface _FinalStage {
    WebhookUserLeaderboardResponse build();
  ...
  public static final class Builder implements IdStage, NameStage, KeyStage, RankByStage, StartStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(WebhookUserLeaderboardResponse other) {
      rank(other.getRank());
    ...
    public WebhookUserLeaderboardResponse build() {
      return new WebhookUserLeaderboardResponse(rank, value, id, name, key, rankBy, breakdownAttribute, breakdownAttributes, metricKey, metricName, pointsSystemKey, pointsSystemName, description, start, end, startTime, endTime, maxParticipants, runUnit, runInterval, previousRank, previousValue, additionalProperties);
    }
