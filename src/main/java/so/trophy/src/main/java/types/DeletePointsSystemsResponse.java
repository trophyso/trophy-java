...
@JsonDeserialize(
    builder = DeletePointsSystemsResponse.Builder.class
)
public final class DeletePointsSystemsResponse {
  ...
  private DeletePointsSystemsResponse(List<DeletedResource> deleted, List<AdminIssue> issues,
  ...
  /**
   * @return Array of deleted points system IDs.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DeletePointsSystemsResponse && equalTo((DeletePointsSystemsResponse) other);
  }
  ...
  private boolean equalTo(DeletePointsSystemsResponse other) {
  ...
  public static final class Builder {
    ...
    public Builder from(DeletePointsSystemsResponse other) {
    ...
    /**
     * <p>Array of deleted points system IDs.</p>
     */
    @JsonSetter(
        value = "deleted",
        nulls = Nulls.SKIP
    ...
    public DeletePointsSystemsResponse build() {
      return new DeletePointsSystemsResponse(deleted, issues, additionalProperties);
    }
