package so.trophy.src.main.java.resources.leaderboards.types;
...
import so.trophy.types.ILeaderboardResponse;
import so.trophy.types.LeaderboardResponseRankBy;
import so.trophy.types.LeaderboardResponseRunUnit;

@JsonInclude(JsonInclude.Include.NON_ABSENT)
@JsonDeserialize(
    builder = LeaderboardsAllResponseItem.Builder.class
)
public final class LeaderboardsAllResponseItem implements ILeaderboardResponse {
   ...
   */
  @JsonProperty("status")
  public LeaderboardsAllResponseItemStatus getStatus() {
    return status;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof LeaderboardsAllResponseItem && equalTo((LeaderboardsAllResponseItem) other);
  }
  ...
  public interface IdStage {
    ...
    Builder from(LeaderboardsAllResponseItem other);
  }
  ...
  public interface StatusStage {
     ...
     */
    _FinalStage status(@NotNull LeaderboardsAllResponseItemStatus status);
  }
  ...
  public static final class Builder implements IdStage, NameStage, KeyStage, RankByStage, StartStage, StatusStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(LeaderboardsAllResponseItem other) {
      id(other.getId());
      name(other.getName());
      key(other.getKey());
