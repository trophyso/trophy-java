...
@JsonDeserialize(
    builder = DeleteTenantsResponse.Builder.class
)
public final class DeleteTenantsResponse {
  ...
  private DeleteTenantsResponse(List<DeletedResource> deleted, List<AdminIssue> issues,
  ...
  /**
   * @return Array of deleted tenant IDs.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DeleteTenantsResponse && equalTo((DeleteTenantsResponse) other);
  }
  ...
  private boolean equalTo(DeleteTenantsResponse other) {
  ...
  public static final class Builder {
    ...
    public Builder from(DeleteTenantsResponse other) {
    ...
    /**
     * <p>Array of deleted tenant IDs.</p>
     */
    @JsonSetter(
        value = "deleted",
        nulls = Nulls.SKIP
    ...
    public DeleteTenantsResponse build() {
      return new DeleteTenantsResponse(deleted, issues, additionalProperties);
    }
