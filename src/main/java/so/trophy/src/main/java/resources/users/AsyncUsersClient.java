...
public class AsyncUsersClient {
   ...
   * Identify a user.
   */
  public CompletableFuture<User> identify(String id, RequestOptions requestOptions) {
    return this.rawClient.identify(id, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<UserPreferencesResponse> updatePreferences(String id,
      RequestOptions requestOptions) {
    return this.rawClient.updatePreferences(id, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<List<UserAchievementWithStatsResponse>> achievements(String id,
      RequestOptions requestOptions) {
    return this.rawClient.achievements(id, requestOptions).thenApply(response -> response.body());
  }
   ...
   * Get a user's streak data.
   */
  public CompletableFuture<StreakResponse> streak(String id, RequestOptions requestOptions) {
    return this.rawClient.streak(id, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<GetUserPointsResponse> points(String id, String key,
      RequestOptions requestOptions) {
    return this.rawClient.points(id, key, requestOptions).thenApply(response -> response.body());
  }
   ...
   */
  public CompletableFuture<List<PointsBoost>> pointsBoosts(String id, String key) {
    return this.rawClient.pointsBoosts(id, key).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<List<PointsBoost>> pointsBoosts(String id, String key,
      RequestOptions requestOptions) {
    return this.rawClient.pointsBoosts(id, key, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<UserLeaderboardResponseWithHistory> leaderboard(String id, String key,
      RequestOptions requestOptions) {
    return this.rawClient.leaderboard(id, key, requestOptions).thenApply(response -> response.body());
  }
   ...
   * Get a user's year-in-review wrapped data.
   */
  public CompletableFuture<WrappedResponse> wrapped(String id, RequestOptions requestOptions) {
    return this.rawClient.wrapped(id, requestOptions).thenApply(response -> response.body());
  }
