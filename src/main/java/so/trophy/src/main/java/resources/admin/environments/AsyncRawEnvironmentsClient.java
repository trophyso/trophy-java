...
public class AsyncRawEnvironmentsClient {
   ...
   */
  public CompletableFuture<TrophyApiHttpResponse<List<AdminEnvironment>>> list() {
    return list(null);
  }
  ...
  public CompletableFuture<TrophyApiHttpResponse<List<AdminEnvironment>>> list(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getAdminURL()).newBuilder()
      ...
      CompletableFuture<TrophyApiHttpResponse<List<AdminEnvironment>>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<AdminEnvironment>>() {}), response));
              return;
            }
            try {
