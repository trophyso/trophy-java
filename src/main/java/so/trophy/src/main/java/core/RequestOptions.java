...
public final class RequestOptions {
  ...
  private RequestOptions(String apiKey, String sdkVersion, String tenantId,
      Optional<Integer> timeout, TimeUnit timeoutTimeUnit, Optional<Integer> maxRetries,
  ...
  public Map<String, String> getHeaders() {
    ...
    if (this.sdkVersion != null) {
      headers.put("X-SDK-VERSION", this.sdkVersion);
    }
  ...
  public static class Builder {
    ...
    public RequestOptions build() {
      return new RequestOptions(apiKey, sdkVersion, tenantId, timeout, timeoutTimeUnit, maxRetries, headers, headerSuppliers, queryParameters, queryParameterSuppliers);
    }
  }
}
