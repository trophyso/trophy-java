...
@JsonDeserialize(
    builder = DeleteStreakPausesResponse.Builder.class
)
public final class DeleteStreakPausesResponse {
  ...
  private DeleteStreakPausesResponse(List<DeletedResource> deleted, List<AdminIssue> issues,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DeleteStreakPausesResponse && equalTo((DeleteStreakPausesResponse) other);
  }
  ...
  private boolean equalTo(DeleteStreakPausesResponse other) {
  ...
  public static final class Builder {
    ...
    public Builder from(DeleteStreakPausesResponse other) {
    ...
    public DeleteStreakPausesResponse build() {
      return new DeleteStreakPausesResponse(deleted, issues, additionalProperties);
    }
