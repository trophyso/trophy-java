...
public class PointsClient {
   ...
   * Get a breakdown of the number of users with points in each range.
   */
  public List<PointsRange> summary(String key, RequestOptions requestOptions) {
    return this.rawClient.summary(key, requestOptions).body();
  }
   ...
   * Get all global boosts for a points system. Finished boosts are excluded by default.
   */
  public List<PointsBoost> boosts(String key, RequestOptions requestOptions) {
    return this.rawClient.boosts(key, requestOptions).body();
  }
