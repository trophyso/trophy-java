...
@JsonDeserialize(
    builder = PointsResponse.Builder.class
)
public final class PointsResponse implements IPointsResponse {
  ...
  private PointsResponse(String id, String key, String name, Optional<String> description,
      Optional<String> badgeUrl, Optional<Double> maxPoints,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PointsResponse && equalTo((PointsResponse) other);
  }
  ...
  private boolean equalTo(PointsResponse other) {
    return id.equals(other.id) && key.equals(other.key) && name.equals(other.name) && description.equals(other.description) && badgeUrl.equals(other.badgeUrl) && maxPoints.equals(other.maxPoints);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.key, this.name, this.description, this.badgeUrl, this.maxPoints);
  }
  ...
  public interface IdStage {
    ...
    Builder from(PointsResponse other);
  }
  ...
  public static final class Builder implements IdStage, KeyStage, NameStage, _FinalStage {
    private String id;
    ...
    @java.lang.Override
    public Builder from(PointsResponse other) {
      id(other.getId());
      key(other.getKey());
      name(other.getName());
    ...
    @java.lang.Override
    public PointsResponse build() {
      return new PointsResponse(id, key, name, description, badgeUrl, maxPoints, additionalProperties);
    }
