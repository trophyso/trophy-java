...
@JsonDeserialize(
    builder = BatchMetricEventUser.Builder.class
)
public final class BatchMetricEventUser {
  ...
  private BatchMetricEventUser(String id, Optional<String> email, Optional<String> name,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof BatchMetricEventUser && equalTo((BatchMetricEventUser) other);
  }
  ...
  private boolean equalTo(BatchMetricEventUser other) {
  ...
  public interface IdStage {
    ...
    Builder from(BatchMetricEventUser other);
  }

  public interface _FinalStage {
    BatchMetricEventUser build();
  ...
  public static final class Builder implements IdStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(BatchMetricEventUser other) {
      id(other.getId());
    ...
    @java.lang.Override
    public BatchMetricEventUser build() {
      return new BatchMetricEventUser(id, email, name, tz, deviceTokens, subscribeToEmails, attributes, additionalProperties);
    }
