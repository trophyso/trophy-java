package so.trophy.src.main.java.resources.points;
...
public class AsyncRawPointsClient {
  ...
  public CompletableFuture<TrophyApiHttpResponse<List<PointsRange>>> summary(String key,
    ...
    return summary(key,PointsSummaryRequest.builder().build(),requestOptions);
  }
  ...
  public CompletableFuture<TrophyApiHttpResponse<List<PointsRange>>> summary(String key,
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<PointsRange>>() {}), response));
              return;
            }
            try {
    ...
    public CompletableFuture<TrophyApiHttpResponse<PointsSystemResponse>> system(String key,
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
          ...
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PointsSystemResponse.class), response));
                return;
              }
              try {
                switch (response.code()) {
      ...
      public CompletableFuture<TrophyApiHttpResponse<List<PointsBoost>>> boosts(String key,
          RequestOptions requestOptions) {
        return boosts(key,PointsBoostsRequest.builder().build(),requestOptions);
      }
        ...
        public CompletableFuture<TrophyApiHttpResponse<List<PointsLevel>>> levels(String key,
            ...
            client.newCall(okhttpRequest).enqueue(new Callback() {
              ...
              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<PointsLevel>>() {}), response));
                    return;
                  }
                  try {
                    switch (response.code()) {
          ...
          public CompletableFuture<TrophyApiHttpResponse<List<PointsLevelSummaryResponseItem>>> levelSummary(
            ...
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getApiURL()).newBuilder()
              ...
              .addPathSegments("points")
              .addPathSegment(key)
              .addPathSegments("level-summary");if (requestOptions != null) {
                requestOptions.getQueryParameters().forEach((_key, _value) -> {
                  httpUrl.addQueryParameter(_key, _value);
                } );
              }
              ...
              client.newCall(okhttpRequest).enqueue(new Callback() {
                ...
                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                  try (ResponseBody responseBody = response.body()) {
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                      future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<PointsLevelSummaryResponseItem>>() {}), response));
                      return;
                    }
                    try {
                      switch (response.code()) {
