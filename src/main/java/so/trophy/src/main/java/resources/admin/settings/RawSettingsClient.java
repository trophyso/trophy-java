...
public class RawSettingsClient {
   ...
   */
  public TrophyApiHttpResponse<AdminSettings> get() {
    return get(null);
  }
   ...
   * Get branding, experimentation, and aggregation settings.
   */
  public TrophyApiHttpResponse<AdminSettings> get(RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getAdminURL()).newBuilder()

      .addPathSegments("settings");if (requestOptions != null) {
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AdminSettings.class), response);
        }
        try {
     ...
     */
    public TrophyApiHttpResponse<AdminSettings> update() {
      return update(UpdateAdminSettingsRequest.builder().build());
    }

    /**
     * Update branding, experimentation, and aggregation settings.
     */
    public TrophyApiHttpResponse<AdminSettings> update(RequestOptions requestOptions) {
      return update(UpdateAdminSettingsRequest.builder().build(),requestOptions);
    }

    /**
     * Update branding, experimentation, and aggregation settings.
     */
    public TrophyApiHttpResponse<AdminSettings> update(UpdateAdminSettingsRequest request) {
