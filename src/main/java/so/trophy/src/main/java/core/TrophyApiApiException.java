 ...
 */
public class TrophyApiApiException extends TrophyApiException {
  /**
  ...
  public String toString() {
    return "TrophyApiApiException{" + "message: " + getMessage() + ", statusCode: " + statusCode + ", body: " + ObjectMappers.stringify(body) + "}";
  }
}
