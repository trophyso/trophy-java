...
public class AsyncAttributesClient {
   ...
   * List attributes.
   */
  public CompletableFuture<List<AdminAttribute>> list(RequestOptions requestOptions) {
   ...
   * Delete attributes by ID.
   */
  public CompletableFuture<DeleteAttributesResponse> delete(RequestOptions requestOptions) {
