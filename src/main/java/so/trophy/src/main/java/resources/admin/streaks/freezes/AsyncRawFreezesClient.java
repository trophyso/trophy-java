package so.trophy.src.main.java.resources.admin.streaks.freezes;
...
public class AsyncRawFreezesClient {
  ...
  public CompletableFuture<TrophyApiHttpResponse<CreateStreakFreezesResponse>> create(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getAdminURL()).newBuilder()
      ...
      .addPathSegments("streaks/freezes");if (requestOptions != null) {
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new TrophyApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateStreakFreezesResponse.class), response));
              return;
            }
            try {
