...
public class BoostsClient {
   ...
   * List points boosts for a system.
   */
  public List<AdminPointsBoost> list(String systemId, RequestOptions requestOptions) {
   ...
   * Delete multiple points boosts by ID.
   */
  public DeletePointsBoostsResponse delete(String systemId, RequestOptions requestOptions) {
