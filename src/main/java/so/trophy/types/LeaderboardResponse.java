...
public final class LeaderboardResponse implements ILeaderboardResponse {
  ...
  private LeaderboardResponse(String id, String name, String key,
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.name, this.key, this.status, this.rankBy, this.metricKey, this.metricName, this.pointsSystemKey, this.pointsSystemName, this.description, this.start, this.end, this.maxParticipants, this.runUnit, this.runInterval);
  }
  ...
  public static final class Builder implements IdStage, NameStage, KeyStage, RankByStage, StartStage, MaxParticipantsStage, RunIntervalStage, _FinalStage {
    ...
    public LeaderboardResponse build() {
      return new LeaderboardResponse(id, name, key, status, rankBy, metricKey, metricName, pointsSystemKey, pointsSystemName, description, start, end, maxParticipants, runUnit, runInterval, additionalProperties);
    }
  }
}
