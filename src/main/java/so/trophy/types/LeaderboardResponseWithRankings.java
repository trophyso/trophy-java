...
public final class LeaderboardResponseWithRankings implements ILeaderboardResponse {
  ...
  private boolean equalTo(LeaderboardResponseWithRankings other) {
    return id.equals(other.id) && name.equals(other.name) && key.equals(other.key) && status.equals(other.status) && rankBy.equals(other.rankBy) && metricKey.equals(other.metricKey) && metricName.equals(other.metricName) && pointsSystemKey.equals(other.pointsSystemKey) && pointsSystemName.equals(other.pointsSystemName) && description.equals(other.description) && start.equals(other.start) && end.equals(other.end) && maxParticipants == other.maxParticipants && runUnit.equals(other.runUnit) && runInterval == other.runInterval && rankings.equals(other.rankings);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.name, this.key, this.status, this.rankBy, this.metricKey, this.metricName, this.pointsSystemKey, this.pointsSystemName, this.description, this.start, this.end, this.maxParticipants, this.runUnit, this.runInterval, this.rankings);
  }
  ...
  public static final class Builder implements IdStage, NameStage, KeyStage, RankByStage, StartStage, MaxParticipantsStage, RunIntervalStage, _FinalStage {
    ...
    public LeaderboardResponseWithRankings build() {
      return new LeaderboardResponseWithRankings(id, name, key, status, rankBy, metricKey, metricName, pointsSystemKey, pointsSystemName, description, start, end, maxParticipants, runUnit, runInterval, rankings, additionalProperties);
    }
  }
}
